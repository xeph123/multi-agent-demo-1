...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-12 pb-24 min-h-screen relative">
      ...
      {/* Edit Profile Overlay - Geometric Silence & Asymmetric Layout */}
      {isEditing && (
          ...
          <div className="bg-white border border-border w-full max-w-2xl p-12 md:p-16 relative transform translate-x-4 -translate-y-2 shadow-2xl my-8">
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-10">
              <div className="space-y-4">
                <label className="font-sans text-xs font-bold tracking-[0.1em] uppercase text-primary block">
                  Name
                </label>
                <Input
                  value={editName}
              ...
              <div className="space-y-4">
                <label className="font-sans text-xs font-bold tracking-[0.1em] uppercase text-primary block">
                  New Password <span className="text-secondary/50 font-normal lowercase tracking-normal">(Leave blank to keep current)</span>
                </label>
