...
async function main() {
  ...
  const userData = [
    { email: 'admin@imr.co.kr', name: 'The Lounge Admin', department: 'Management', role: 'ADMIN' },
    { email: 'sarah.j@imr.co.kr', name: 'Sarah Jenkins', department: 'Design Strategy', role: 'USER' },
    { email: 'michael.c@imr.co.kr', name: 'Michael Chen', department: 'R&D Lab', role: 'USER' },
    { email: 'elena.v@imr.co.kr', name: 'Elena Volkov', department: 'Brand Experience', role: 'USER' },
    { email: 'david.k@imr.co.kr', name: 'David Kim', department: 'Platform Engineering', role: 'USER' },
  ]
